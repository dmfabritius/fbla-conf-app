...
namespace FBLA_Conference_System {
    ...
    public partial class EventWinnersLarge : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            string sqlConferenceEventTeams =
                "SELECT * FROM (SELECT DISTINCT EventID,Place," +
                ...
                "WHERE Place IS NOT NULL AND ConferenceID=" + EventWinnersConferenceID + ") AS Teams" +
                " ORDER BY CHECKSUM(CAST(EventID as nvarchar)+TeamName+Place)";
            ...
            string sqlConferenceEventWinners =
                ...
                " ORDER BY LastName,FirstName,ChapterName";
