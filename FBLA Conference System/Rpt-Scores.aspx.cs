...
{
    public partial class Rpt_Scores : System.Web.UI.Page
    {
        ...
        protected void ddConferences_DataBound(object sender, EventArgs e) {
            ...
            if (ddConferences.Items.Count == 0) {
                ...
                Session["EventWinnersConferenceID"] = "";
            } else {
                ddConferences.Enabled = true;
                Session["EventWinnersConferenceID"] = ddConferences.SelectedValue;
                gvEventWinners.DataBind();
            }
        }
